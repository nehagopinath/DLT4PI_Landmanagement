...
function networkDown() {
  ...
  docker-compose -f $COMPOSE_FILE -f $COMPOSE_FILE_COUCH -f $COMPOSE_FILE_KAFKA -f $COMPOSE_FILE_RAFT2 -f $COMPOSE_FILE_ORG4 down --volumes --remove-orphans
...
# Using docker-compose-e2e-template.yaml and docker-compose-cas.yaml replace constants with private key file names
